...
export class RSAutilsComponent implements OnInit {
  ...
  constructor() {
    ...
    -----END PUBLIC KEY-----`;
      ...
      const decryptDataRow = `T7lL2gWfbo4vwSIl9akIhpv/+Ww7RIZA+Mb0M+Op6fey4EErkaJTUTFRy5EIka3MccFZnoP7cPDnegw2z4FgHm1oU6ytn0vg5uOz6meo8qlvnUEFmjlrBmQqGsMry+QIBT6muUZVIeq8AgANyAYL6S6T5vtHZpOPeO04Zcckpmc=`;
